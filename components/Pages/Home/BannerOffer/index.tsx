...
const BannerOfferHomePage = () => {
    ...
    <div className="relative h-[50vh] flex-center flex-col overflow-hidden">
        ...
        <BannerContent title="Masaż we Wrocławiu" subtitle="Masaż we Wrocławiu to doskonały sposób na relaks, redukcję napięcia i poprawę samopoczucia. Oferuje profesjonalne masaże odprężające, sportowe i regeneracyjne." />
